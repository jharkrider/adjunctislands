    ...
    constructor(params, firebaseStorage, firebaseDatabase) {
        ...
        this.initPreExperiment = () => {
            ...
            var welcome = {
                ...
                stimulus: "<p>Welcome!</p><p>Press continue to move onto the instructions.</p>",
            ...
            var instructions = {
                type: jsPsychHtmlButtonResponse,
                stimulus: "<p>In this survey, you will hear English sentences. You will be asked to rate how good these sentences sound on a scale of 1 (unacceptable) to 7 (perfectly acceptable).</p><p>Please try to answer on your first instinct. Remember there is no right or wrong answer!</p><p>When you are ready, press continue to continue to the experiment.",
                choices: ['Continue'],
                on_finish: function(data) {
        ...
        var initTrial = (stimulus) => {
            return {
                ...
                questions: [
                    {
                        prompt: "How good does this sentence sound?",
                        labels: [
                            "1<br>Unacceptable",
                            "2",
                            "3",
                ...
                on_start: function() {
                    var audio = new Audio( `../resources/data/audio/${stimulus[6]}`)
                    audio.play()
                },
                on_finish: function(data) {
                    data.stimulus = stimulus[7]
                    data.response = data.response.Q0
                    data.id = stimulus[2]
                    data.condition = stimulus[3]
                }
            }
        }
        ...
        this.initPostExperiment = (jsPsych) => {
            var thankYou = {
                ...
                stimulus:  "Thank you! Your response has been recorded! You are free to exit out of this window.",
