...
const firebaseConfig = {
  apiKey: "AIzaSyBZuDYeG_oo0txwwQSN8mrE_gbPuL44fPg",
  authDomain: "adjunct-islands.firebaseapp.com",
  databaseURL: "https://adjunct-islands-default-rtdb.firebaseio.com",
  projectId: "adjunct-islands",
  storageBucket: "adjunct-islands.appspot.com",
  messagingSenderId: "318168724849",
  appId: "1:318168724849:web:8bc1653d27ec2400df72d0"
};
...
var validateExpID = (expID) => {
    ...
    const idList = ["T1", "T2", "I1", "I2", "W1", "W2"]

    if (idList.includes(expID)) {
            return true;
    }
